...
## Project Structure
    ...
    ├── testapiautostoryboa_98029  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_98029`
...
2. Clone this repo and `cd testapiautostoryboa_98029`
